...
export const Pricing = () => (
  <section id="prijzen" className="bg-white py-24 lg:py-32">
    <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
      <ChapterTag number="04" label="Prijzen" />
        ...
        <div className="lg:col-span-7">
          <Reveal>
            <h2 className="font-outfit font-black uppercase tracking-tighter text-brand-ink text-4xl sm:text-5xl lg:text-6xl leading-[0.95]">
              Eerlijk geprijsd. <span className="text-brand-blue">Vooraf afgesproken.</span>
            </h2>
            <p className="mt-6 max-w-xl font-manrope text-base md:text-lg text-zinc-500 leading-relaxed">
              U weet altijd waar u aan toe bent. Wij werken nooit zonder dat u de prijs heeft
              goedgekeurd.
            </p>
          </Reveal>
          ...
          <p className="mt-6 font-manrope text-xs text-zinc-400">
            Vanaf-prijzen, indicatief en excl. btw. Definitieve prijs steeds in een offerte vooraf.
          </p>
        </div>
          ...
          >
            ...
            <div>
              ...
              <p className="mt-4 font-manrope text-base text-zinc-300 leading-relaxed">
                op uw eerste interventie. Vermeld de code{" "}
                <strong className="text-white">SANIVOLT15</strong> bij uw aanvraag.
              </p>
            </div>
            <a
              href="#contact"
            ...
            <p className="sr-only">Of bel {SITE.phoneDisplay}</p>
          </div>
        </Reveal>
      </div>
    </div>
