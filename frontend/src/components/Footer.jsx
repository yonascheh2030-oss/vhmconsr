        ...
        <div className="mt-16 grid md:grid-cols-3 gap-10 border-t border-white/10 pt-12">
          <div>
            ...
            <p className="mt-3 flex items-center gap-3 font-manrope text-sm text-zinc-400">
              <MapPin className="w-4 h-4 text-brand-volt" /> {t.footer.locationLine}
            </p>
          </div>
          <div>
            <p className="font-manrope text-[11px] font-bold tracking-[0.25em] uppercase text-zinc-500 mb-5">{t.footer.servicesLabel}</p>
            <ul className="space-y-2 font-manrope text-sm text-zinc-400">
              {t.footer.servicesList.map((d) => (
                <li key={d} className="hover:text-white transition-colors">{d}</li>
              ))}
            </ul>
          </div>
          <div>
            <p className="font-manrope text-[11px] font-bold tracking-[0.25em] uppercase text-zinc-500 mb-5">{t.footer.areasLabel}</p>
